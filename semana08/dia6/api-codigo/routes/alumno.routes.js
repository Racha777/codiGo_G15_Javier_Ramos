...
function alumnoApi(app){
    ...
    router.post('/',validatorHandler(createAlumnoSchema,'body'),async function(req,res){
    ...
    router.put('/:id',validatorHandler(updateAlumnoSchema,'body'),async function(req,res){
        const {id}=req.params;
        const {body:data}=req;
